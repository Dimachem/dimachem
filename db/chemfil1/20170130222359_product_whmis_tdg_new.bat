...
ECHO 	[Product WHMIS TDG New]	`CHEMFIL1_DEVELOPMENT`	`product_whmis_tdg_new`	[INVENTCODE]	`INVENTCODE`	[INVENTCODE], [WHMIS CLASS], [TDG SHIP NAME], [TDG CLASS], [TDG UN#], [TDG PG], [TDG PLACARD], [Label Code] >> "%TMP%\wb_tables_to_migrate.txt"
