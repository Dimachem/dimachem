...
ECHO 	[Raw Materials]	`CHEMFIL1_DEVELOPMENT`	`raw_materials`	[Champ Code]	`Champ Code`	[Champ Code], [Name], [SUPPLIER1], [Volume1], [SUPPLIER3], [SUPPLIER3], [LBS PER GAL], [MIN POUNDS], [QC], [RAW MATERIAL], [DATE CODED], [CODED BY], [TYPE], [DSL COMPLIANT], [NDSL TRIGGER], [SAMPLE], [SAMPLE CONTAINER], [SAMPLE MIX], [PurchComments], [UsedInAutoProdParts] >> "%TMP%\wb_tables_to_migrate.txt"
