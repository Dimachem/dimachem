...
ECHO 	[Champ Code Table]	`CHEMFIL1_DEVELOPMENT`	`champ_code`	[Product Code]	`Product Code`	[ID], [DATE SETUP], [Product Code], [Product Name], [DESCRIPTION], [WEIGHT], [SPEC GRAV], [INVENTCODE], [PASSTHROUGHRAWCHAMPCODE], [CLASS], [Sales Class], [Margin], [GP TARGET], [StandardProduct], [ActiveCode], [BRAND], [LABEL NAME], [LABEL RAW], [PACKAGING MO], [VOLUME], [FILLKG], [EACHCONTAINEREXTENSION], [KGCONTAINEREXTENSION], [SELL PRICE DATE], [SELL PRICE COMMENTS], [EACH SELL PRICE], [DEFAULTSELLUNITS], [SELLMETHOD], [PURPOSE], [FAB HEADER], [FAB], [MOU], [INVENTORY METHOD], [DYNAMICSELLMETHOD], [TEMPSELL], [6MOAVGBATCHCOST], [TEMPTHEORETICALCOST], [LASTBATCHCOST], [LASTBATCHDATE] >> "%TMP%\wb_tables_to_migrate.txt"
