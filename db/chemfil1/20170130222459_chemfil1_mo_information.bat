...
ECHO 	[MO Information]	`CHEMFIL1_DEVELOPMENT`	`mo_information`	[PRODUCT CODE]	`PRODUCT CODE`	[PRODUCT CODE], [ISSUE DATE], [ISSUED BY], [REVISION DATE], [REVISED BY], [HANDLING INST], [SAFETY EQUIP], [LABEL], [BATCH LBS], [BATCH DR], [YIELD], [ACTIVE], [DATE NON ACT], [FLAG], [FLAG SOURCE], [CLASS], [Sub Class], [ID REQUIRED], [StorageLocation], [DockAudit], [LeadTime] >> "%TMP%\wb_tables_to_migrate.txt"
