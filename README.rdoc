...
TODO:
- move git repo to dimachem (done)
- update steps order (done)
- update ETL for formula assets
  - update migration .bat
  - write tests
  * 1:1 now 1:m !!
- app authentication (login)
  - login to vpn (done)
  - todo app role and author
- add status filter default open + all (use browser? => save time/money)
- get formula status list * open => complete => archived (done)
